...
const url = 'https://api.unsplash.com/collections/429524/photos?client_id=2eEW2PZQpGVVSVAMd4sA4lHQ3tqHdsEia1RAdgo6x4M&page=1&per_page=200';
...
const seedDB = async () => {
    ...
    for (let i = 0; i < 200; i++) {
        ...
        const camp = new Campground({
            ...
            price,
            images: { url: allPhotos[i % 30].urls.regular, filename: 'SEEDED IMAGE' }
        });
        await camp.save();
    }
};
